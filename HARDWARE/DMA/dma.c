...
//cmar:存储器地址
//cndtr:数据传输量 
void UartRxDMA1_Config(DMA_Channel_TypeDef* DMA_CHx,u32 cpar,u32 cmar,u16 cndtr)
{
...
//开启一次DMA传输
void DMA_Enable(DMA_Channel_TypeDef*DMA_CHx, u16 ndtr)
{ 
	DMA_Cmd(DMA_CHx, DISABLE);  //关闭USART  DMA 所指示的通道   
 	DMA_SetCurrDataCounter(DMA_CHx,ndtr);//DMA通道的DMA缓存的大小
 	DMA_Cmd(DMA_CHx, ENABLE);  //使能USART  DMA 所指示的通道 
}	  
